...
|기본 타입에 대한 강박관념|Replace Type Code with Class(383)<br>Replace State-Altering Conditionals with State(234)<br>[Replace Conditional Logic with Strategy](https://jo631.github.io/refactoring/2021/04/15/Replace-Conditional-Logic-with-Strategy/)<br>[Replace Implicit Tree with Composite](https://jo631.github.io/refactoring/2021/04/19/Replace-Implicit-Tree-with-Composite/)<br>Replace Implicit Language with Interpreter(360)<br>Move Embellishment to Decorator(206)<br>Encapsulate Composite with Builder(145)|
