...
|패턴|목표|지향|제거|
|:---|:---:|:---:|:---:|
|Adapter|[Extract Adapter](https://jo631.github.io/refactoring/2021/05/02/Extract-Adapter/)<br> Unify interfaces with Adapter(333)|Unify Interfaces with Adapter(333)||
